      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
            <div class="px-4">
				<img id="myImage" src="" class="rounded-circle img-top img-fluid  shadow-lg--hover" style="width: 200px;"></br> <!-- connie place holder for mouse over-->
              <img src="Toronto.jpg" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;" onmouseover="displayImage('Toronto.jpg')" onmouseout="hideImage()">
