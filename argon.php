...
<head>
  ...
  <meta property="og:title" content="Argon - Free Design System for Bootstrap 4 by Creative Tim" />
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-xl">
                <div class="dropdown-menu-inner">
                  ...
                  <a href="./docs/components/alerts.html" class="media d-flex align-items-center">
      ...
      <div class="container py-md">
        <div class="row justify-content-between align-items-center">
          <div class="col-lg-5 mb-5 mb-lg-0">
            ...
            <a href="./docs/components/alerts.html" class="btn btn-white mt-4">See all components</a>
          </div>
